...
namespace model_modFitExpGP_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_modFitExpGP");
    reader.add_event(149, 147, "end", "model_modFitExpGP");
    return reader;
}
...
#include <meta_header.hpp>
 class model_modFitExpGP : public prob_grad {
private:
    int N;
    vector<double> x;
    vector_d y;
    ...
    matrix_d Sigma0;
public:
    model_modFitExpGP(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_modFitExpGP_namespace::model_modFitExpGP";
        ...
        try {
            ...
            validate_non_negative_index("u", "Nn", Nn);
            num_params_r__ += Nn;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("u", "Nn", Nn);
        context__.validate_dims("initialization", "u", "vector_d", context__.to_vec(Nn));
        vector_d u(static_cast<Eigen::VectorXd::Index>(Nn));
        for (int j1__ = 0U; j1__ < Nn; ++j1__)
            u(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_lb_unconstrain(0,u);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                u = in__.vector_lb_constrain(0,Nn,lp__);
            else
                u = in__.vector_lb_constrain(0,Nn);
            ...
            lp_accum__.add(gamma_log<propto__>(lambda, 2, lambda_rate));
            current_statement_begin__ = 122;
            for (int n = 1; n <= Nn; ++n) {
                current_statement_begin__ = 123;
                lp_accum__.add(gamma_log<propto__>(get_base1(u,n,"u",1), 2, lambda));
            }
            current_statement_begin__ = 124;
            for (int n = 1; n <= Nn; ++n) {
                current_statement_begin__ = 125;
                lp_accum__.add(normal_log<propto__>(get_base1(yGP,n,"yGP",1), 0, get_base1(u,n,"u",1)));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_modFitExpGP_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector_d theta = in__.vector_lb_constrain(0,Np);
        vector_d u = in__.vector_lb_constrain(0,Nn);
...
typedef model_modFitExpGP_namespace::model_modFitExpGP stan_model;
